    ...
    .directive('ngDrag', ['$rootScope', '$parse', '$document', '$window', 'ngDraggable', function ($rootScope, $parse, $document, $window, ngDraggable) {
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                scope.offsetLeft = attrs.offsetLeft;
                var _dragReset = (attrs.dragReset == 'false') ? false : true;
                var _axisX = (/x/.test(attrs.dragAxis))  ? true : false;
                var _axisY = (/y/.test(attrs.dragAxis))  ? true : false;
                ...
                var reset = function() {
                    if(_dragReset){
                        ...
                        attrs.$set('offset-left', (parseFloat(element.css('left')) || 0) + _tx);
                      //  scope.offsetLeft = (parseFloat(element.css('left')) || 0) + _tx;
                      //  console.log(scope.offsetLeft)
                        element.css('left',  (parseFloat(element.css('left')) || 0) + _tx +'px');
                        element.css({transform:'', 'z-index':''});
                    }
